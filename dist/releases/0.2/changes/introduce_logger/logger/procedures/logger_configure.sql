...
-- changeset LOGGER:1772904354397 stripComments:false  logicalFilePath:introduce_logger\logger\procedures\logger_configure.sql
-- sqlcl_snapshot src/database/logger/procedures/logger_configure.sql:null:9ace017fff2fc7aeb246172041a61521d1b65add:create

create or replace procedure logger.logger_configure is
